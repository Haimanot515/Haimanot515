...
<div style="display: flex; align-items: center; justify-content: space-between; gap: 20px;">
  ...
  <div style="flex: 2;">
    ...
    <p>
      Currently, I’m specializing in the MERN stack (MongoDB, Express.js, React, Node.js) while exploring modern tools like Next.js and TypeScript to enhance performance and user experience.
    </p>
  </div>
  ...
  <div style="flex: 1; text-align: center;">
    <img src="https://res.cloudinary.com/dq3jkpys8/image/upload/v1772087655/home_hero/fl68t8mbmg2io6qbux5g.jpg" 
         alt="Haimanot Beka" 
         width="300" 
         style= " align :right border-radius: 50%; border: 4px solid #61DAFB; max-width: 100%; height: auto;" />
  </div>
